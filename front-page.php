    ...
    <div class="container-custom">
        ...
        <div class="grid md:grid-cols-4 gap-8">
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; text-align: center; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
                <div class="icon-box-blue mx-auto mb-4" style="width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, #0693e3, #9b51e0); display: flex; align-items: center; justify-content: center;">
            ...
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; text-align: center; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
                <div class="icon-box-purple mx-auto mb-4" style="width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, #9b51e0, #0693e3); display: flex; align-items: center; justify-content: center;">
...
<section id="services" class="section relative overflow-hidden" style="background: #FFFFFF; padding: 80px 0;">
    <div class="container-custom">
        <div class="text-center mb-12">
            <h2 class="text-5xl font-bold mb-4" style="color: #0693e3;">Our Services</h2>
            <p class="text-xl" style="color: #666;">Comprehensive ABA therapy tailored to your family needs</p>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); border-top: 4px solid #0693e3;">
                <div class="icon-box-blue mb-6" style="width: 64px; height: 64px; border-radius: 16px; background: linear-gradient(135deg, #0693e3, #9b51e0); display: flex; align-items: center; justify-content: center;">
                ...
                <a href="<?php echo home_url("/services"); ?>" class="font-semibold" style="color: #0693e3;">Learn more &rarr;</a>
            </div>
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); border-top: 4px solid #9b51e0;">
                <div class="icon-box-purple mb-6" style="width: 64px; height: 64px; border-radius: 16px; background: linear-gradient(135deg, #9b51e0, #0693e3); display: flex; align-items: center; justify-content: center;">
                ...
                <a href="<?php echo home_url("/services"); ?>" class="font-semibold" style="color: #9b51e0;">Learn more &rarr;</a>
            </div>
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; box-shadow: 0 10px 40px rgba(0,0,0,0.1); border-top: 4px solid #0693e3;">
                <div class="icon-box-blue mb-6" style="width: 64px; height: 64px; border-radius: 16px; background: linear-gradient(135deg, #0693e3, #9b51e0); display: flex; align-items: center; justify-content: center;">
...
<section id="why-choose-us" class="section" style="background: rgba(6, 147, 227, 0.05); padding: 80px 0;">
    <div class="container-custom">
        ...
        <div class="grid md:grid-cols-3 gap-12 text-center">
            <div>
                <div class="mx-auto mb-6" style="width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg, #0693e3, #9b51e0); display: flex; align-items: center; justify-content: center;">
            ...
            <div>
                <div class="mx-auto mb-6" style="width: 80px; height: 80px; border-radius: 50%; background: linear-gradient(135deg, #9b51e0, #0693e3); display: flex; align-items: center; justify-content: center;">
...
<section id="process" class="section" style="background: #FFFFFF; padding: 80px 0;">
    <div class="container-custom">
        <div class="text-center mb-12">
            <h2 class="text-5xl font-bold mb-6" style="color: #0693e3;">Getting Started is Easy</h2>
            <p class="text-xl" style="color: #666;">Four simple steps to begin your child journey</p>
        </div>
        <div class="grid md:grid-cols-4 gap-8 text-center">
            <div>
                <div class="mx-auto mb-6" style="width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, #0693e3, #9b51e0); display: flex; align-items: center; justify-content: center;">
            ...
            <div>
                <div class="mx-auto mb-6" style="width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, #9b51e0, #0693e3); display: flex; align-items: center; justify-content: center;">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
                ...
                <div class="flex items-center gap-3">
                    <div style="width: 48px; height: 48px; border-radius: 50%; background: linear-gradient(135deg, #0693e3, #9b51e0);"></div>
                    <div>
            ...
            <div class="card-elevated" style="background: white; border-radius: 16px; padding: 32px; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
                ...
                <div class="flex items-center gap-3">
                    <div style="width: 48px; height: 48px; border-radius: 50%; background: linear-gradient(135deg, #9b51e0, #0693e3);"></div>
                    <div>
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        <div style="width: 48px; height: 48px; border-radius: 50%; background: rgba(255,255,255,0.1); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <svg class="w-6 h-6" style="color: #0693e3;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-start gap-4">
                        <div style="width: 48px; height: 48px; border-radius: 50%; background: rgba(255,255,255,0.1); display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <svg class="w-6 h-6" style="color: #9b51e0;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        </div>
                        <div>
            ...
            <div>
                <div style="background: white; border-radius: 24px; padding: 32px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);">
                    ...
                    <form action="<?php echo esc_url( admin_url("admin-post.php") ); ?>" method="POST" class="space-y-4">
                        ...
                        <button type="submit" class="btn btn-primary" style="width: 100%; padding: 16px; background: linear-gradient(135deg, #0693e3, #9b51e0); color: white; border: none; border-radius: 8px; font-size: 18px; font-weight: 600; cursor: pointer;">Request Free Consultation</button>
                    </form>
                </div>
            </div>
        </div>
